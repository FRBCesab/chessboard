...
```{r 'cb-transects-quadrats', fig.height=8, fig.width=6, echo=FALSE, fig.cap="Figure 1. Two-dimensional network"}
...
```{r 'cb-transects-only', fig.height=3, fig.width=8, echo=FALSE, fig.cap="Figure 2. Transects-only network"}
...
On the other hand, if the sampling has been conducted only through qudrats, a
fictitious transect will be added with only one transect (Fig.3).


```{r 'cb-quadrats-only', fig.height=8, fig.width=3, echo=FALSE, fig.cap="Figure 3. Quadrats-only network", }
