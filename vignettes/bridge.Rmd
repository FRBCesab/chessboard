...
Note that is the units of the coordinates system are in degrees, the Great Circle
distance will be used instead. See the documentation of the function `distance_euclidean()`
for further detail.
