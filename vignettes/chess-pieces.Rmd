...
```{r eval=FALSE, echo=TRUE}
create_edge_list(nodes, method = "bishop_right", degree = 4, ...)
```
...
```{r eval=FALSE, echo=TRUE}
create_edge_list(nodes, method = "bishop_left", degree = 4, ...)
```
...
```{r eval=FALSE, echo=TRUE}
create_edge_list(nodes, method = "knight_right", degree = 4, ...)
```
...
```{r eval=FALSE, echo=TRUE}
create_edge_list(nodes, method = "knight_left", degree = 4, ...)
```
