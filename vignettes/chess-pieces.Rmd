...
```{r eval=FALSE, echo=TRUE}
create_edges_list(nodes, method = "pawn", degree = 4, ...)
```
...
```{r eval=FALSE, echo=TRUE}
create_edges_list(nodes, method = "fool", degree = 4, ...)
```
...
```{r eval=FALSE, echo=TRUE}
create_edges_list(nodes, method = "rook", degree = 4, ...)
```
...
```{r eval=FALSE, echo=TRUE}
create_edges_list(nodes, method = "bishop", degree = 4, ...)
```
...
> The `bishop_right` is a special case of the `bishop` and 
can detect neighbors along one diagonal (from bottom-left to top-right).

The function `bishop_right()` can be used to detect neighbors (black dots in Fig. 9) of a specific node (red dot in Fig. 9).

```{r eval=FALSE, echo=TRUE}
bishop_right(nodes, focus = "5-5", degree = 4, ...)
```
...
```{r 'cb-bishop-right', eval=TRUE, fig.height=4.3, fig.width=12, echo=FALSE, fig.cap="Figure 9. Moves of the **Bishop right** (with degree = 4)", out.width='100%'}
bishop_right_1 <- 
  gg_chessboard(nodes, "A. Undirected network", "") + 
  geom_node(nodes, focus) +
  geom_neighbors(nodes, bishop_right(nodes, focus, degree = 4, directed = FALSE,
                                     reverse = FALSE))

bishop_right_2 <- 
  gg_chessboard(nodes, "B. Directed network", "") + 
  geom_node(nodes, focus) +
  geom_neighbors(nodes, bishop_right(nodes, focus, degree = 4, directed = TRUE,
                                     reverse = FALSE))
...
are detected by the `bishop_right` method and with a degree of neighborhood of 4.

```{r eval=FALSE, echo=TRUE}
create_edges_list(nodes, method = "bishop_right", degree = 4, ...)
```
...
```{r 'cb-bishop_right-mat', eval=TRUE, fig.height=4.3, fig.width=12, echo=FALSE, fig.cap="Figure 10. Connectivity matrices of the **Bishop right** (with degree = 4)", out.width='100%'}
nb_1 <- create_edges_list(nodes, 
                          method   = "bishop_right", 
                          degree   = 4, 
                          directed = FALSE, 
...
bishop_right_1 <- gg_matrix(connectivity_matrix(nb_1), "A. Undirected network") +
  theme(axis.text = element_blank(), axis.text.x = element_blank(),
        plot.caption = ggplot2::element_text(family = "mono", size = 12, 
            face = "bold", hjust = 0.5))
...
bishop_right_2 <- gg_matrix(connectivity_matrix(nb_2), "B. Directed network") +
  theme(axis.text = element_blank(), axis.text.x = element_blank(),
        plot.caption = ggplot2::element_text(family = "mono", size = 12, 
            face = "bold", hjust = 0.5))
...
bishop_right_3 <- gg_matrix(connectivity_matrix(nb_3), "C. Directed network (reverse)") +
  theme(axis.text = element_blank(), axis.text.x = element_blank(),
        plot.caption = ggplot2::element_text(family = "mono", size = 12, 
            face = "bold", hjust = 0.5))
...
> The `bishop_left` is a special case of the `bishop` and can detect 
neighbors along one diagonal (from bottom-right to top-left). 

The function `bishop_left()` can be used to detect neighbors (black dots in Fig. 11) of a specific node (red dot in Fig. 11).

```{r eval=FALSE, echo=TRUE}
bishop_left(nodes, focus = "5-5", degree = 4, ...)
```
...
```{r 'cb-bishop-left', eval=TRUE, fig.height=4.3, fig.width=12, echo=FALSE, fig.cap="Figure 11. Moves of the **Bishop left** (with degree = 4)", out.width='100%'}
bishop_left_1 <- 
  gg_chessboard(nodes, "A. Undirected network", "") + 
  geom_node(nodes, focus) +
  geom_neighbors(nodes, bishop_left(nodes, focus, degree = 4, directed = FALSE, 
                                    reverse = FALSE))
...
are detected by the `bishop_left` method and with a degree of neighborhood of 4.

```{r eval=FALSE, echo=TRUE}
create_edges_list(nodes, method = "bishop_left", degree = 4, ...)
```
...
```{r 'cb-bishop_left-mat', eval=TRUE, fig.height=4.3, fig.width=12, echo=FALSE, fig.cap="Figure 12. Connectivity matrices of the **Bishop left** (with degree = 4)", out.width='100%'}
nb_1 <- create_edges_list(nodes, 
                          method   = "bishop_left", 
                          degree   = 4, 
                          directed = FALSE, 
...
bishop_left_1 <- gg_matrix(connectivity_matrix(nb_1), "A. Undirected network") +
  theme(axis.text = element_blank(), axis.text.x = element_blank(),
        plot.caption = ggplot2::element_text(family = "mono", size = 12, 
            face = "bold", hjust = 0.5))
...
bishop_left_2 <- gg_matrix(connectivity_matrix(nb_2), "B. Directed network") +
  theme(axis.text = element_blank(), axis.text.x = element_blank(),
        plot.caption = ggplot2::element_text(family = "mono", size = 12, 
            face = "bold", hjust = 0.5))
...
bishop_left_3 <- gg_matrix(connectivity_matrix(nb_3), "C. Directed network (reverse)") +
  theme(axis.text = element_blank(), axis.text.x = element_blank(),
        plot.caption = ggplot2::element_text(family = "mono", size = 12, 
            face = "bold", hjust = 0.5))
...
The function `knight()` can be used to detect neighbors (black dots in Fig. 13) of a specific node (red dot in Fig. 13).
...
```{r 'cb-knight', eval=TRUE, fig.height=4.3, fig.width=12, echo=FALSE, fig.cap="Figure 13. Moves of the **Knight** (with degree = 4)", out.width='100%'}
knight_1 <- 
  gg_chessboard(nodes, "A. Undirected network", "") + 
  geom_node(nodes, focus) +
...
```{r eval=FALSE, echo=TRUE}
create_edges_list(nodes, method = "knight", degree = 4, ...)
```
...
```{r 'cb-knight-mat', eval=TRUE, fig.height=4.3, fig.width=12, echo=FALSE, fig.cap="Figure 14. Connectivity matrices of the **Knight** (with degree = 4)", out.width='100%'}
nb_1 <- create_edges_list(nodes, 
                          method   = "knight", 
                          degree   = 4, 
                          directed = FALSE, 
...
> The `knight_right` is a special case of the `knight`.

The function `knight_right()` can be used to detect neighbors (black dots in Fig. 15) of a specific node (red dot in Fig. 15).

```{r eval=FALSE, echo=TRUE}
knight_right(nodes, focus = "5-5", degree = 4, ...)
```

User can change the default settings (Fig. 15A), by adding directionality 
...
```{r 'cb-knight-right', eval=TRUE, fig.height=4.3, fig.width=12, echo=FALSE, fig.cap="Figure 15. Moves of the **Knight right** (with degree = 4)", out.width='100%'}
knight_right_1 <- 
  gg_chessboard(nodes, "A. Undirected network", "") + 
  geom_node(nodes, focus) +
  geom_neighbors(nodes, knight_right(nodes, focus, degree = 4, directed = FALSE,
                                     reverse = FALSE))

knight_right_2 <- 
  gg_chessboard(nodes, "B. Directed network", "") + 
  geom_node(nodes, focus) +
  geom_neighbors(nodes, knight_right(nodes, focus, degree = 4, directed = TRUE,
                                     reverse = FALSE))
...
Figure 16 shows the connectivity matrix of the 9 x 9 network when neighbors of all nodes
are detected by the `knight_right` method and with a degree of neighborhood of 4.

```{r eval=FALSE, echo=TRUE}
create_edges_list(nodes, method = "knight_right", degree = 4, ...)
```
...
```{r 'cb-knight_right-mat', eval=TRUE, fig.height=4.3, fig.width=12, echo=FALSE, fig.cap="Figure 16. Connectivity matrices of the **Knight right** (with degree = 4)", out.width='100%'}
nb_1 <- create_edges_list(nodes, 
                          method   = "knight_right", 
                          degree   = 4, 
                          directed = FALSE, 
...
knight_right_1 <- gg_matrix(connectivity_matrix(nb_1), "A. Undirected network") +
  theme(axis.text = element_blank(), axis.text.x = element_blank(),
        plot.caption = ggplot2::element_text(family = "mono", size = 12, 
            face = "bold", hjust = 0.5))
...
knight_right_2 <- gg_matrix(connectivity_matrix(nb_2), "B. Directed network") +
  theme(axis.text = element_blank(), axis.text.x = element_blank(),
        plot.caption = ggplot2::element_text(family = "mono", size = 12, 
            face = "bold", hjust = 0.5))
...
knight_right_3 <- gg_matrix(connectivity_matrix(nb_3), "C. Directed network (reverse)") +
  theme(axis.text = element_blank(), axis.text.x = element_blank(),
        plot.caption = ggplot2::element_text(family = "mono", size = 12, 
            face = "bold", hjust = 0.5))
...
> The `knight_left` is a special case of the `knight`.

The function `knight_left()` can be used to detect neighbors (black dots in Fig. 17) of a specific node (red dot in Fig. 17).

```{r eval=FALSE, echo=TRUE}
knight_left(nodes, focus = "5-5", degree = 4, ...)
```

User can change the default settings (Fig. 17A), by adding directionality 
(`directed = TRUE`, Fig. 17B) and reversing the default directionality 
(`directed = TRUE` and `reverse = TRUE`, Fig. 17C).

\


```{r 'cb-knight-left', eval=TRUE, fig.height=4.3, fig.width=12, echo=FALSE, fig.cap="Figure 17. Moves of the **Knight left** (with degree = 4)", out.width='100%'}
knight_left_1 <- 
  gg_chessboard(nodes, "A. Undirected network", "") + 
  geom_node(nodes, focus) +
  geom_neighbors(nodes, knight_left(nodes, focus, degree = 4, directed = FALSE, 
                                    reverse = FALSE))
...
Figure 18 shows the connectivity matrix of the 9 x 9 network when neighbors of all nodes
are detected by the `knight_left` method and with a degree of neighborhood of 4.

```{r eval=FALSE, echo=TRUE}
create_edges_list(nodes, method = "knight_left", degree = 4, ...)
```
...
```{r 'cb-knight_left-mat', eval=TRUE, fig.height=4.3, fig.width=12, echo=FALSE, fig.cap="Figure 18. Connectivity matrices of the **Knight left** (with degree = 4)", out.width='100%'}
nb_1 <- create_edges_list(nodes, 
                          method   = "knight_left", 
                          degree   = 4, 
                          directed = FALSE, 
...
knight_left_1 <- gg_matrix(connectivity_matrix(nb_1), "A. Undirected network") +
  theme(axis.text = element_blank(), axis.text.x = element_blank(),
        plot.caption = ggplot2::element_text(family = "mono", size = 12, 
            face = "bold", hjust = 0.5))
...
knight_left_2 <- gg_matrix(connectivity_matrix(nb_2), "B. Directed network") +
  theme(axis.text = element_blank(), axis.text.x = element_blank(),
        plot.caption = ggplot2::element_text(family = "mono", size = 12, 
            face = "bold", hjust = 0.5))
...
knight_left_3 <- gg_matrix(connectivity_matrix(nb_3), "C. Directed network (reverse)") +
  theme(axis.text = element_blank(), axis.text.x = element_blank(),
        plot.caption = ggplot2::element_text(family = "mono", size = 12, 
            face = "bold", hjust = 0.5))
...
The function `queen()` can be used to detect neighbors (black dots in Fig. 19) of a specific node (red dot in Fig. 19).

```{r eval=FALSE, echo=TRUE}
queen(nodes, focus = "5-5", degree = 4, ...)
```

User can change the default settings (Fig. 19A), by adding directionality 
(`directed = TRUE`, Fig. 19B) and reversing the default directionality 
(`directed = TRUE` and `reverse = TRUE`, Fig. 19C).

\


```{r 'cb-queen', eval=TRUE, fig.height=4.3, fig.width=12, echo=FALSE, fig.cap="Figure 19. Moves of the **Queen** (with degree = 4)", out.width='100%'}
queen_1 <- 
  gg_chessboard(nodes, "A. Undirected network", "") + 
  geom_node(nodes, focus) +
...
Figure 20 shows the connectivity matrix of the 9 x 9 network when neighbors of all nodes
are detected by the `queen` method and with a degree of neighborhood of 4.

```{r eval=FALSE, echo=TRUE}
create_edges_list(nodes, method = "queen", degree = 4, ...)
```
...
```{r 'cb-queen-mat', eval=TRUE, fig.height=4.3, fig.width=12, echo=FALSE, fig.cap="Figure 20. Connectivity matrices of the **Queen** (with degree = 4)", out.width='100%'}
nb_1 <- create_edges_list(nodes, 
                          method   = "queen", 
                          degree   = 4, 
                          directed = FALSE, 
...
The function `wizard()` can be used to detect neighbors (black dots in Fig. 21) of a specific node (red dot in Fig. 21).

```{r eval=FALSE, echo=TRUE}
wizard(nodes, focus = "5-5", degree = 4, ...)
```

User can change the default settings (Fig. 21A), by adding directionality 
(`directed = TRUE`, Fig. 21B) and reversing the default directionality 
(`directed = TRUE` and `reverse = TRUE`, Fig. 21C).
\


```{r 'cb-wizard', eval=TRUE, fig.height=4.3, fig.width=12, echo=FALSE, fig.cap="Figure 21. Moves of the **Wizard** (with degree = 4)", out.width='100%'}
wizard_1 <- 
  gg_chessboard(nodes, "A. Undirected network", "") + 
  geom_node(nodes, focus) +
...
Figure 22 shows the connectivity matrix of the 9 x 9 network when neighbors of all nodes
are detected by the `wizard` method and with a degree of neighborhood of 4.

```{r eval=FALSE, echo=TRUE}
create_edges_list(nodes, method = "wizard", degree = 4, ...)
```
...
```{r 'cb-wizard-mat', eval=TRUE, fig.height=4.3, fig.width=12, echo=FALSE, fig.cap="Figure 22. Connectivity matrices of the **Wizard** (with degree = 4)", out.width='100%'}
nb_1 <- create_edges_list(nodes, 
                          method   = "wizard", 
                          degree   = 4, 
                          directed = FALSE, 
...
```{r 'cb-custom', eval=TRUE, fig.height=4.3, fig.width=12, echo=FALSE, fig.cap="Figure 23. Custom moves", out.width='100%'}
wizard_1 <- 
