...
Instead, it identifies neighbors according to the **node labels**
(i.e. the node positions on a two-dimension chessboard) and a specific method 
...
The node labels are a combination of the transect identifier (i.e. the position 
...
This function returns an edges list, i.e. a two-column `data.frame` where a row
...
A companion paper will be published soon. In the meantime, if you want to use 
the package, please use the following citation: 
